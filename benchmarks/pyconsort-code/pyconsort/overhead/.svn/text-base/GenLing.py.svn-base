...
eastern=['Tamil','Telugu','Gujarati','Marathi','Bengali','Punjabi','Kannada','Malayalam']

class Open():
 def __init__(self):
  for adir in dir(self):
   pass 

class GenDb():
 RECS="pan.alephnull.com dictd 1.12.0/rf on Linux 3.0.0-14-server <auth.mime> <11877061.31540.1357068168@pan.alephnull.com>"
 DATS={"gcide":"The Collaborative International Dictionary of English v.0.48",
