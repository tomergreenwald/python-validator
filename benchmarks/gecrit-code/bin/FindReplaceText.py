...
class SearchReplace:
    ...
    def FindDocText(self, text_id):
        ...
        FindDialog = wx.FindReplaceDialog(None, FindData, "Find")
    ...
    def ReplaceDocText(self, text_id):
        ...
        FdRpFrame = wx.Frame(None, -1, "Search and Replace", size=(300,
                             300))
        FdRpData = wx.FindReplaceData()
        ReplaceDialog = wx.FindReplaceDialog(FdRpFrame, FdRpData,
                "Search and Replace", style=wx.FR_REPLACEDIALOG)
